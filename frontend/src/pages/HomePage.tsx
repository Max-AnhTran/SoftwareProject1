...
const HomePage: React.FC = () => {
    ...
    const fetchCategories = async () => {
        try {
            console.log(`Fetching categories from ${import.meta.env.VITE_BACKEND_URL}/api/categories`);
    ...
    return (
        <div className="space-y-16">
            ...
            <section className="max-w-6xl mx-auto px-4">
                <h2 className="text-3xl font-bold text-center text-gray-800 mb-8">Browse By Categories</h2>
             ...
             "
                        >
                            <h3 className="text-2xl font-semibold text-blue-600 mb-3">{cat.name}</h3>
            ...
            <section className="bg-gray-50 py-12">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((f, idx) => (
                            <div key={idx} className="bg-white p-6 rounded-xl shadow-lg flex flex-col items-center">
